            ...
            <div className='max-w-md w-full bg-white/95 dark:bg-gray-900/90 backdrop-blur-xl rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.3)] p-10 border border-white/20 transform transition-all hover:scale-[1.01]'>
                ...
                <form onSubmit={handleSubmit} className='space-y-5'>
                    <div>
                        ...
                        <input type='text' value={name} onChange={(e)=>setName(e.target.value)} required className='w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none dark:bg-gray-700 dark:text-white transition-all' placeholder='John Doe'/>
                    </div>
                    <div>
                    ...
                    <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
                        ...
                        <div>
                            ...
                            <input type='password' value={confirmPassword} onChange={(e)=>setConfirmPassword(e.target.value)} required className='w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none dark:bg-gray-700 dark:text-white transition-all' placeholder='••••••••'/>
                        </div>
                    </div>
                ...
                <p className='mt-8 text-center text-sm text-gray-500 dark:text-gray-400'>Already have an account?{' '}
                    <Link to='/login' className='text-blue-600 dark:text-blue-400 hover:underline font-bold'>Login here</Link>
                </p>
            </div>
        </div>
    )
